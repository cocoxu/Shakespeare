...
%Argue why BLEU might capture writing style in addition to semantic adequacy
%Argue that we really want to seperate these two measures
%Present initial results from human evaluation (plot? - table?)
%Plot style vs. equivelance...?

\section{New Metrics Evaluating Writing Style}
