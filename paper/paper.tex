...
possible to learn paraphrase models which capture stylistic phenomena, and these models outperform
...
\begin{table}[ht]
  \begin{center}
    \begin{tabular}{|l|p{3in}|}
      ...
      \hline
      \hline
      16and7plays\_36LM & Phrase table extracted from all 16 Sparknotes plays and 7 Enotes plays (holding out R\&J) and language model built from all 36 of Shakespeare's plays, again excluding R\&J.
...
is what portion of its improvements are due to stylistic similarity or semantic equivalence.  For this reason, we were motivated to perform
...
We note that overall the automatic metrics tend to agree with human judgments as displayed in Figure \ref{style_metrics}.\footnote{
...
Perhaps most relevant, however, is recent work on automatic generation of rhythmic poetry \cite{Greene10}.  This work focuses on automatically generating and translating
