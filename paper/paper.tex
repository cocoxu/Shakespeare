...
data are presented in Figure \ref{shakespeare_to_modern_automatic}, correlation of the automatic metrics with with human judgements are presented in 
Figure \ref{correlation_s2m} and overall average human judgements are presented in Figure \ref{human_judgements}.
