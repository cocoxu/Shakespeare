...
Although two utterances might be semantically equivalent, they can still be stylistically quite different.  For example, the same information
...
Phrase-based translation has been demonstrated as an effective approach to paraphrasing \cite{quirk04chen11}, however this approach does require the existence of
...
>>>>>>> 499f0ca24b8c90f2f7b93eff8ac905268ffbaf71
...
<<<<<<< HEAD
\subsection{Examples}
Several example paraphrases of lines from {\em Romeo and Juliet} and a few Hollywood movies, generated by the top performing system according to BLEU and PINC, are presented in table \ref{examples}.
