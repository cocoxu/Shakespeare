...
def average_score (filename):
    ...
    sm = StyleMetric('../models/Translators/16plays_36LM/data/train_plays_lowercased.original', '../models/Translators/16plays_36LM/data/train_plays_lowercased.modern')
    ...
    for line in open(filename):
        ...
        _16plays36_overall_list.append(float(_16plays36_overall))
        ...
        phrase_overall_list.append(float(phrase_overall))
        ...
        video_overall_list.append(float(video_overall))
 
        i += 1

    print "16plays36:"
    print "average-semantic\t" + str(mean(_16plays36_semantic_list))
    print "average-dissim\t" + str(mean(_16plays36_dissim_list))
    print "average-style\t" + str(mean(_16plays36_style_list))
    print "average-overall\t" + str(mean(_16plays36_overall_list))

    print "phrase2:"
    print "average-semantic\t" + str(mean(phrase_semantic_list))
    print "average-dissim\t" + str(mean(phrase_dissim_list))
    print "average-style\t" + str(mean(phrase_style_list))
    print "average-overall\t" + str(mean(phrase_overall_list))

    print "video2:"
    print "average-semantic\t" + str(mean(video_semantic_list))
    print "average-dissim\t" + str(mean(video_dissim_list))
    print "average-style\t" + str(mean(video_style_list))
    print "average-overall\t" + str(mean(video_overall_list))



def average_score_full (filename):
    ...
    print "16plays36:"
    print "average-bleu\t" + str(mean(_16plays36_bleu_list))
    print "average-pinc\t" + str(mean(_16plays36_pinc_list))
    print "average-semantic\t" + str(mean(_16plays36_semantic_list))
    print "average-dissim\t" + str(mean(_16plays36_dissim_list))
    print "average-style\t" + str(mean(_16plays36_style_list))
    print "average-csim\t" + str(mean(_16plays36_csim_list))
    print "average-cmaxent\t" + str(mean(_16plays36_cmaxent_list))
    print "average-lmdiff5\t" + str(mean(_16plays36_lmdiff5_list))

    print "phrase2:"
    print "average-bleu\t" + str(mean(phrase_bleu_list))
    print "average-pinc\t" + str(mean(phrase_pinc_list))
    print "average-semantic\t" + str(mean(phrase_semantic_list))
    print "average-dissim\t" + str(mean(phrase_dissim_list))
    print "average-style\t" + str(mean(phrase_style_list))
    print "average-csim\t" + str(mean(phrase_csim_list))
    print "average-cmaxent\t" + str(mean(phrase_cmaxent_list))
    print "average-lmdiff5\t" + str(mean(phrase_lmdiff5_list))

    print "video2:"
    print "average-pinc\t" + str(mean(video_bleu_list))
    print "average-pinc\t" + str(mean(video_pinc_list))
    print "average-semantic\t" + str(mean(video_semantic_list))
    print "average-dissim\t" + str(mean(video_dissim_list))
    print "average-style\t" + str(mean(video_style_list))
    print "average-csim\t" + str(mean(video_csim_list))
    print "average-cmaxent\t" + str(mean(video_cmaxent_list))
    print "average-lmdiff5\t" + str(mean(video_lmdiff5_list))
